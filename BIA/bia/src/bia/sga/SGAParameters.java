...
public class SGAParameters extends Properties {
    ...
    private String functionName = "solution.bia.sga.ExampleFunction"; // fitness function class name
    private ContinuousFunction function = null; // fitness function
    private int genesPerValue = 24;      // chromosome size
    ...
    private int crossType = 1;      // crossover type
    ...
    private int replacementType = 0;// replacement strategy type
    //---
