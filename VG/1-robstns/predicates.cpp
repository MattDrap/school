...
#include "predicates.h"           // PF Defines the symbol REAL (float or double).
...
void setFPURoundingTo64Bits()
{
#ifdef WIN32
  _control87(_PC_64, _MCW_PC); /* Set FPU control word for double precision. */
#endif /* WIN32 */
#ifdef LINUX
  //FIXME change the constant to extended precision. Currently it is set to double.
  /*  cword = 4735; */
  cword = 4722;                 /* set FPU control word for double precision */
  _FPU_SETCW(cword);
#endif /* LINUX */
