...
Coef = zeros(1,3);
Coef(1) = 0.5 * 1/distribution2.Sigma^2 - 0.5 * 1/distribution1.Sigma^2;
...
Coef(3) = log(distribution1.Prior/distribution2.Prior)...
    ...
    + 0.5 * (distribution2.Mean^2)/distribution2.Sigma^2 - 0.5 * (distribution1.Mean^2)/distribution1.Sigma^2;
